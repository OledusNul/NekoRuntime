...
public class MessageManager {
    ...
    public void initDialogInScene(AbstractScene scene, AbstractDialog dialog) throws Throwable {
...
//        dialogRoot.setLayoutX(scene.getScene().getWidth() / 2 - 140);
//        dialogRoot.setLayoutY(20);
    ...
    public void showApplyDialog(String header, String text, Runnable onApplyCallback, Runnable onDenyCallback, Runnable onCloseCallback, boolean isLauncher) {
        ...
        showAbstractDialog(dialog, header, isLauncher);
        new FadeIn(dialog.layout).setSpeed(1.5).play();
    }
